...
public class form7 extends AppCompatActivity {
    ...
    public EditText f7_editText1;
    public EditText f7_editText2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            jsonOutput.put("form", 7);
            jsonOutput.put("nextForm", 7);
        } catch (Exception e){}
...
//        f7_editText2.setInputType(InputType.TYPE_NULL);
        ...
        f7_editText2.setOnEditorActionListener(new TextView.OnEditorActionListener() {
    ...
    private void sendPostRequest(Runnable onComplete) {
        new Thread(() -> {
            try {
                ...
                jsonOutput.put("p1", f7_editText1.getText().toString().trim());
                jsonOutput.put("p2", f7_editText2.getText().toString().trim());
                    ...
                    runOnUiThread(() -> {
                        ...
                        if (msg.isEmpty()) {
                            try {
                                jsonOutput.put("p1", "");
                                jsonOutput.put("p2", "");
                                jsonOutput.put("d", f7_editText1.getText().toString().trim());
